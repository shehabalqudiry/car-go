        ...
        <div class="container container_log">
            <div class="row">
                ...
                <ul class="nav nav-tabs navnav-tabs2">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" href="{{ route('front.shipments.index', 'outgoing') }}"><i
                                class="fa-solid fa-circle-check"></i>
                            {{ __('Shipments') . ' ' . __('Outgoing') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.shipments.index', 'incoming') }}">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active">
                        @livewire('search-my-shipment', ['outgoing' => $outgoing])
                    </div>
                </div>
            </div>
